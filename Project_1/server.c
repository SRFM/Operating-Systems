...
void process_request() {
  ...
  total_service_time += (service_time_temp.tv_usec - entry_time.tv_usec) + (service_time_temp.tv_sec - entry_time.tv_sec) * 1000000;
  total_waiting_time += (got_it_from_queue_time_temp.tv_usec - entry_time.tv_usec) + (got_it_from_queue_time_temp.tv_sec - entry_time.tv_sec) * 1000000;
